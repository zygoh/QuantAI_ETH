...
def add_volume_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    try:
        ...
        price_change_1 = close_for_pct_corr.pct_change(1, fill_method=None)
        price_change_1 = price_change_1.replace([np.inf, -np.inf], np.nan)
        
        price_change_5 = close_for_pct_corr.pct_change(5, fill_method=None)
        price_change_5 = price_change_5.replace([np.inf, -np.inf], np.nan)
        
        volume_change_5 = volume_for_pct_corr.pct_change(5, fill_method=None)
